...
<body>
                ...
                <table class="table table-striped table-bordered table-hover" id="sample-table">
                    <thead>
                        <tr>
                            ...
                            <th width="50px">ID</th>
                            <th width="150px">广告位名称</th>
                            <th width="100px">广告高</th>
                            <th width="100px">广告宽</th>
                            <th width="70px">状态</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                                ...
                                <td class="td-manage">
                                    ...
                                    <a title="编辑"  href="{{ route('adpos_edit',['id'=>$v->id]) }}" id="sort_edit" class="btn btn-xs btn-info"><i class="fa fa-edit bigger-120"></i></a>
                                    <a title="删除" href="{{ route('adpos_delete',['id'=>$v->id]) }}" onclick="confirm('确定要删除吗？')" class="btn btn-xs btn-warning"><i
                                            class="fa fa-trash  bigger-120"></i></a>
                                    {{-- <a href="javascript:ovid()" name="Ads_list.html" class="btn btn-xs btn-pink ads_link"
                                        onclick="AdlistOrders('561');" title="幻灯片广告列表"><i class="fa  fa-bars  bigger-120"></i></a> --}}
                                </td>
                            </tr>
                        @endforeach
    ...
    <div class="sort_style_add margin" id="sort_style_add" style="display:none">
        <form action="{{ route('adpos_doadd') }}" method="POST">
            @csrf
        <div class="">
            <ul>
                <li><label class="label_name">广告位名称</label>
                    <div class="col-sm-9"><input name="po_name" type="text" id="form-field-1" placeholder="" class="col-xs-10 col-sm-5"></div>
                </li>
                <li><label class="label_name">广告宽度</label>
                    <div class="col-sm-9"><input name="po_width" type="text" id="form-field-1" placeholder="" class="col-xs-10 col-sm-5"></div>
                </li>
                <li><label class="label_name">广告高度</label>
                    <div class="col-sm-9"><input name="po_height" type="text" id="form-field-1" placeholder="" class="col-xs-10 col-sm-5"></div>
                </li>
