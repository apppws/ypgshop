...
<body>
    <div class="Competence_add_style clearfix">
        <form action="{{ route('adpos_doedit',['id'=>$adpos->id]) }}" method="post" class="form form-horizontal" id="form-article-add"
            enctype="multipart/form-data" name="form">
            @csrf
            <div class="left_Competence_add">
                <div class="title_name">修改广告位置</div>
                ...
                <div class="Competence_add">
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1">
                            广告位名称 </label>
                        <div class="col-sm-9">
                            <input type="text" value="{{ $adpos->po_name }}" id="form-field-1" placeholder="" name="po_name"
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1">
                            广告宽度 </label>
                            <div class="col-sm-9">
                                    <input type="text" value="{{ $adpos->po_width }}" id="form-field-1" placeholder="" name="po_width"
                                        class="col-xs-10 col-sm-5">
                                </div>
                    </div>
                    <div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1">
                            广告高度 </label>
                            <div class="col-sm-9">
                                    <input type="text" value="{{ $adpos->po_height }}" id="form-field-1" placeholder="" name="po_height"
                                        class="col-xs-10 col-sm-5">
                                </div>
                    </div>
                </div>
