...
<head>
    ...
    <title>1号店登录</title>
    <link href="/becss/pc_login_new.css?1561453" rel="stylesheet" type="text/css" />
    <script type="text/javascript" src="/bejs/pc_login_new.js?1561453"></script>
        ...
        <div class="wrap clearfix">
            <div class="mod_login_wrap">
                ...
                <div class="login_form">
                    ...
                    <form action="{{ route('dobelogin') }}" method="POST">
                        @csrf
                    <div class="form_item_wrap">
                        <div class="form_item">
                            <label class="user_ico">&nbsp;</label>
                            <input id="un" type="text" name="username" spellcheck="false" tabIndex="1"
                                class="ipt ipt_username" style="outline: none;" value="" />
                        </div>
                        <div class="form_item">
                            <label class="paswd_ico">&nbsp;</label>
                            <input id="pwd" type="password" oncopy="return false" onpaste="return false" oncut="return false"
                                oncontextmenu="return false" name="password" tabIndex="2" class="ipt ipt_password gay_text"
                                placeholder="密码 " style="outline: none;" />
                        ...
                        {{-- <div id='vcd_div' class="verify_code clearfix">
                            ...
                            <div class="form_item cur_right">
                                ...
                                <input id="vcd" type="text" name="validCode" maxlength="4" tabindex="1" value="验证码"
                                    class="ipt ipt_code gay_text" onblur="javascript: jsLoginValidatCode.checkValidCodeOnBlur()"
                            ...
                            <a class="verify_code_box" onclick="jsLoginValidatCode.passport_refresh_valid_code();return false;"
                                href="#">
                        ...
                        <div class="auto_login clearfix">
                            ...
                            <p class="service_agreement">点击登录，表示您同意1号店<a href="http://cms.yhd.com/cms/view.do?topicId=24110"
                                    class="blue_link" target="_blank">《服务协议》</a></p>
                    ...
                    <div class="joint_landing_wrap">
                        ...
                        <div class="clearfix">
                            <ul class="account_list clearfix">
                                <li><a href="https://passport.yhd.com/qq/login.do" target="_blank" class="iconfont"
                                        title="QQ">&#xe606;</a></li>
                                <li><a href="https://passport.yhd.com/sina/login.do" target="_blank" class="iconfont"
                                        title="新浪微博">&#xe608;</a></li>
                                <li><a href="https://passport.yhd.com/alipay/login.do" target="_blank" class="iconfont"
                                        title="支付宝">&#xe601;</a></li>
                                <li><a href="https://passport.yhd.com/wechat/login.do" target="_blank" class="iconfont"
                                        title="微信">&#xe609;</a></li>
                            </ul>
                        ...
                        <ul class="more_landing clearfix">
                            ...
                            <li><a href="javascript:alert('现已终止与139邮箱合作，请您采用其他方式登录。已绑定手机用户可通过手机号和密码登录。账号相关问题可致电客服电话400-007-1111。给您带来不便，表示抱歉！');"><i
            ...
            <div class="mod_left_banner"><a id="imgLink" target="_blank"><img id="img" src="/beimages/CgQDsFbYC-GASWzbAADDGtrKi4k66400.jpg" /></a></div>
        </div>
    </div>
