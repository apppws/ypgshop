...
<body>
    <div class="clearfix" id="add_picture">
        <div class="page_right_style">
            <div class="type_title">添加商品属性并查看已有的属性</div>
            <form action="{{ route('goods_doattr',['id'=>$data->id]) }}" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
                @csrf
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if($v->attr_options)
                                    @php $arr = explode(',',$v->attr_options)  @endphp
                                    <select name="attr_value[]" id="">
                                        <option value="">==请选择==</option>
                                        @foreach ($arr as $v1 )
                                        <option @if(isset($gaData[$v->id])) selected="selected" @endif value="{{ $v1 }}">{{ $v1 }}</option>
                                        @endforeach
                                    </select>
                                    @else
                                    <input type="text" name="attr_value[]" id="">
                                    @endif
                                </td>
                            </tr>
                            @endforeach
