...
<form action="{{ route('privilege_doedit',['id'=>$data->id]) }}" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
    @csrf
    <div class="left_Competence_add">
   <div class="title_name">修改权限</div>
    <div class="Competence_add">
        <div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 上级权限 </label>
            <div class="col-sm-9">
        ...
        <div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 权限名称 </label>
            <div class="col-sm-9">
                <input type="text" value="{{ $data->pri_name }}" id="form-field-1" placeholder=""  name="pri_name" class="col-xs-10 col-sm-5">
            </div>
        </div>
        <div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 路由地址 </label>
            <div class="col-sm-9">
                <input type="text" id="form-field-1" placeholder="" value="{{ $data->url_path }}"  name="url_path" class="col-xs-10 col-sm-5">
            </div>
        </div>
        </div>
            <!--按钮操作-->
