...
<body>
    <div class="margin clearfix">
        <div class="border clearfix">
            <span class="l_f">
                <a href="{{ route('privilege_add') }}" id="Competence_add" class="btn btn-warning" title="添加权限"><i class="fa fa-plus"></i>
                    添加权限</a>
            ...
            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $v->url_path }}</td>
                        <td>
                            <a title="编辑" href="{{ route('privilege_edit',['id'=>$v->id]) }}" class="btn btn-xs btn-info"><i
                                    class="fa fa-edit bigger-120"></i></a>
                            <a title="删除" onclick="confirm('你确定要删除吗？')" href="{{ route('privilege_delete',['id'=>$v->id]) }}"  class="btn btn-xs btn-warning"><i
