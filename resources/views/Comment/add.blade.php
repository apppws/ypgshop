...
<body>
    <div class=" clearfix">
    <form action="{{ route('comment_doadd',['id'=>$id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="left_add">
                ...
                <ul class="add_conent">
                    <li class=" clearfix"><label class="label_name"><i>*</i>评分：</label>
                        ...
                        <input type="radio" name="star" value="3"> 3分
                    ...
                    <li class=" clearfix"><label class="label_name">品牌描述：</label>
                        <textarea name="content" cols="" rows="" class="textarea" onkeyup="checkLength(this);"></textarea>
                        <span class="wordage">品牌描述：
                            <span id="sy" style="color:Red;">500</span>字
                        </span>
                    </li>
                    <li class=" clearfix"><label class="label_name"><i>*</i>是否显示：</label>
                        <input type="radio" name="is_show" value="y"> 显示
                        <input type="radio" name="is_show" value="n"> 不显示
                    </li>
                </ul>
            </div>
