...
<body>
    <div class="margin clearfix">
        <div class="Guestbook_style">
            <div class="search_style">
                    <form>
                        <ul class="search_content clearfix">
                            <li><label class="l_f">评论内容</label>
                                <input name="keyword" value="{{ $req->keyword }}" type="text" class="text_add" placeholder="输入评论内容" style=" width:400px" />
                            </li>
            ...
            <div class="border clearfix">
                ...
                <a href="{{ route('goods')}}" class="btn btn-sm btn-primary"><i class="fa fa-check"></i>&nbsp;添加要跳转到商品</a>
                </span>
                ...
                <table class="table table-striped table-bordered table-hover" id="sample-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-l">
                                {{ $v->content }}
                            <td>{{ $v->isshow=='y'?'显示':'不显示' }}</td>
                            <td>
                                <img src="{{'/upload/'.$v->mid_pic}}" alt="" width="150px" height="150px">
                            </td>
                            <td class="td-manage">
                                <a  title="修改" href="/comment/edit/{{ $v->id }}/{{ $v->goods_id}}" class="btn btn-xs btn-info">
    ...
    <div id="Guestbook" style="display:none">
        <div class="content_style">
            <div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1">留言用户
                </label>
                <div class="col-sm-9">胡海天堂</div>
            </div>
            <div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 留言内容
                </label>
            ...
            <div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1">是否回复
                </label>
                <div class="col-sm-9">
