...
<form action="{{ route('role_doadd') }}" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
    @csrf
   ...
   <div class="title_name">添加角色</div>
    <div class="Competence_add">
        ...
        <div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 权限列表 </label>
            <div class="col-sm-9">
                    ...
                    <ul>
                            ...
                            <li level="{{$v->level}}">
                                ...
                                <input name="pri_id[]" value="{{$v->id}}" type="checkbox">
                                {{$v->pri_name}}
                            </li>
                            @endforeach
                        </ul>
