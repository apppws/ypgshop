...
<body>
    <div class="margin clearfix">
        <div class="border clearfix">
            <span class="l_f">
                <a href="{{ route('role_add') }}" id="Competence_add" class="btn btn-warning" title="添加权限"><i class="fa fa-plus"></i>
                    添加角色</a>
            ...
            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $v->id }}</td>
                        <td>{{ str_repeat('-',8*$v->level).$v->role_name }}</td>
                        <td>
                            <a title="编辑" href="{{ route('role_edit',['id'=>$v->id]) }}" class="btn btn-xs btn-info"><i
                                    class="fa fa-edit bigger-120"></i></a>
                            <a title="删除" onclick="confirm('你确定要删除吗？')" href="{{ route('role_delete',['id'=>$v->id]) }}"  class="btn btn-xs btn-warning"><i
