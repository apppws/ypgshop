        ...
        <div id="Member_Ratings">
            <div class="d_Confirm_Order_style">
                ...
                <div class="border clearfix">
                    <span class="l_f">
                        <a href="{{ route('memberadd') }}" id="member_add" class="btn btn-warning"><i class="icon-plus"></i>添加用户</a>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>{{ $v->id }}</td>
                                <td><u style="cursor:pointer" class="text-primary" onclick="member_show('{{$v->username}}','member-show.html','10001','500','400')">{{ $v->username }}</u></td>
                                <td>{{ $v->sex }}</td>
                                <td>{{ $v->birthday }}</td>
                                <td>{{ $v->phone }}</td>
                                <td>{{ $v->email }}</td>
                                ...
                                <td class="td-manage">
                                    ...
                                    <a title="编辑"  href="/member/edit/{{$v->id}}" class="btn btn-xs btn-info"><i
                                            class="icon-edit bigger-120"></i></a>
                                    <a title="删除" onclick="confirm('你确定要删除吗？')" href="/member/delete/{{$v->id}}" class="btn btn-xs btn-warning"><i
