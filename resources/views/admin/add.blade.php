...
<body>
        <div class="Competence_add_style clearfix">
                <form action="{{ route('admin_doadd') }}" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="Competence_add">
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 角色列表 </label>
                            <div class="col-sm-9">
                                ...
                                <input type="checkbox" name="role_id[]" value="{{$v->id}}"> {{$v->role_name}}
                                @endforeach
                            </div>
                        </div>
                        </div>
