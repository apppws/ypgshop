...
<body>
    <div class="type_style">
        ...
        <div class="type_content">
            <form target="_top" action="{{ route('categorydoedit',['id'=>$data->id]) }}" method="post" class="form form-horizontal" id="form-user-add">
                {{ csrf_field() }}
                <div class="Operate_cont clearfix">
                    ...
                    <span style="float:left;">
                        ...
                        <select name="parent1_id" size="10">
                            ...
                            @foreach($topCat as $v)
                            <option @if($data->id==$v->id) selected="selected" @endif value="{{$v->id}}">
                                {{$v->name}}
                            </option>
                        @endforeach
                        </select>
                ...
                <div class="Operate_cont clearfix">
                        ...
                        <div class="formControls ">
                            <input type="text" class="input-text" id="user-name" name="name" value="{{$data->name}}"/>
                        </div>
                </div>
                <div class="">
