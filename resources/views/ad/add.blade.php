...
<body>
    ...
    <form action="{{ route('ad_doadd') }}" method="POST" enctype="multipart/form-data">
        ...
        <div id="add_brand" class="clearfix">
            <div class="left_add">
                <div class="title_name">添加广告</div>
                <div class="clearfix cl">
                        <label class="form-label col-2">商品分类：</label>
                </div>
                <ul class="add_conent">
                    <li class=" clearfix"><label class="label_name"><i>*</i>广告位置：</label>
                            <select name="po_id">
                                <option value="" selected="selected">==选择广告位==</option>
                            </select>
                    </li>
                    <li class=" clearfix"><label class="label_name"><i>*</i>广告名称：</label>
                        <input name="adname" type="text" class="add_text" required / >
                    </li>
                    ...
                    <li class=" clearfix"><label class="label_name"><i>*</i>广告链接：</label>
                        <input name="url" type="text" class="add_text" required / >
                    </li>
                    <li class=" clearfix"><label class="label_name">广告文字：</label>
                        <textarea name="code" cols="" rows="" class="textarea" onkeyup="checkLength(this);"></textarea>
