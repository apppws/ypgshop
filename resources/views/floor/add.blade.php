...
<body>
    <div class=" clearfix">
    <form action="{{ route('floor_doadd') }}" method="POST" enctype="multipart/form-data">
            @csrf
        <div id="add_brand" class="clearfix">
            <div class="left_add">
                <div class="title_name">添加楼层</div>
                ...
                <ul class="add_conent">
                    ...
                    <li class=" clearfix"><label class="label_name"><i>*</i>楼层名称：</label>
                        <input name="flo_name" type="text" class="add_text" required / >
                    </li>
                    <li class=" clearfix"><label class="label_name"><i>*</i>排序数字</label>
                        <input name="sort_num" type="text" class="add_text"/>
                    </li>
                    <li class=" clearfix"><label class="label_name"><i>*</i>广告图片链接</label>
                        <input name="ad_img_link" type="text" class="add_text"/>
                    </li>
                    <li class=" clearfix"><label class="label_name"><i>*</i>推荐小标题1:</label>
                        <input name="subtitle1" type="text" class="add_text" style="width:120px" />
                    </li>
                    <li class=" clearfix"><label class="label_name"><i>*</i>推荐小标题2:</label>
                        <input name="subtitle2" type="text" class="add_text" style="width:120px" />
                    </li>
                    <li class=" clearfix"><label class="label_name"><i>*</i>推荐小标题3:</label>
                        <input name="subtitle3" type="text" class="add_text" style="width:120px" />
                    </li>
                    <li class=" clearfix"><label class="label_name"><i>*</i>推荐小标题4:</label>
                        <input name="subtitle4" type="text" class="add_text" style="width:120px" />
                    </li>
                    <li class=" clearfix"><label class="label_name"><i>*</i>推荐小标题5:</label>
                        <input name="subtitle5" type="text" class="add_text" style="width:120px" />
                    </li>
                    <li class=" clearfix"><label class="label_name"><i>*</i>推荐1商品ID列表：</label>
                        <input name="goods_id1" type="text" class="add_text" style="width:120px" />
                    </li>
                    <li class=" clearfix"><label class="label_name"><i>*</i>推荐2商品ID列表：</label>
                        <input name="goods_id2" type="text" class="add_text" style="width:120px" />
                    </li>
                    <li class=" clearfix"><label class="label_name"><i>*</i>推荐3商品ID列表：</label>
                        <input name="goods_id3" type="text" class="add_text" style="width:120px" />
                    </li>
                    <li class=" clearfix"><label class="label_name"><i>*</i>推荐4商品ID列表：</label>
                        <input name="goods_id4" type="text" class="add_text" style="width:120px" />
                    </li>
                    <li class=" clearfix"><label class="label_name"><i>*</i>推荐5商品ID列表：</label>
                        <input name="goods_id5" type="text" class="add_text" style="width:120px" />
                    </li>
...
<script>
  ...
  // 选择图片的时候调用cropper插件
  $("input[name=ad_img]").change(function () {
    // console.log(x);
