        ...
        <div id="Member_Ratings">
            <div class="d_Confirm_Order_style">
                ...
                <div class="border clearfix">
                    <span class="l_f">
                        <a href="{{ route('floor_add') }}" id="member_add" class="btn btn-warning"><i class="icon-plus"></i>添加用户</a>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample-table">
                                <thead>
                                 <tr>
                                        ...
                                        <th width="80px">ID</th>
                                        <th width="120px">广告LOGO</th>
                                        <th width="250px">楼层名称</th>
                                        <th width="130px">排序</th>
                                        <th width="70px">状态</th>
                                ...
                                <tr>
                                  ...
                                  <td width="120px">
                                         @if($v->ad_img)
                                            <img src="{{$v->ad_img}}" width="130">
                                        @endif
                                    </td>
                                  <th width="250px">{{ $v->flo_name }}</th>
                                  <td width="130px">{{ $v->sort_num }}</td>
                                  ...
                                  <td width="450px"  class="td-manage">
                                    ...
                                    <a title="编辑" href="/floor/edit/{{$v->id}}"  class="btn btn-xs btn-info" >
                                        <i class="icon-edit bigger-120"></i>
                                    </a>
                                    <a title="删除" onclick="confirm('你确定要删除吗？')" href="/floor/delete/{{$v->id}}" onclick="member_del(this,'1')" class="btn btn-xs btn-warning" ><i class="icon-trash  bigger-120"></i></a>
                                  </td>
                                </tr>
                                @endforeach
                                </tbody>
