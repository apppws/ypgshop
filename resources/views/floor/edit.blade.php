...
<body>
    <div class=" clearfix">
    <form action="{{ route('floor_doedit',['id'=>$data->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
        <div id="add_brand" class="clearfix">
            <div class="left_add">
                ...
                <ul class="add_conent">
                    ...
                    <li class=" clearfix"><label class="label_name"><i>*</i>楼层名称：</label>
                        <input name="flo_name" value="{{ $data->flo_name }}" type="text" class="add_text" required / >
                    </li>
                    <li class=" clearfix"><label class="label_name"><i>*</i>排序数字</label>
                        <input name="sort_num" value="{{ $data->sort_num }}" type="text" class="add_text"/>
                    </li>
                    <li class=" clearfix"><label class="label_name"><i>*</i>广告图片链接</label>
                        <input name="ad_img_link" value="{{ $data->ad_img_link }}"  type="text" class="add_text"/>
                    </li>
                    <li class=" clearfix"><label class="label_name"><i>*</i>推荐小标题1:</label>
                        <input name="subtitle1" value="{{ $data->subtitle1 }}" type="text" class="add_text" style="width:120px" />
                    </li>
                    <li class=" clearfix"><label class="label_name"><i>*</i>推荐小标题2:</label>
                        <input name="subtitle2" value="{{ $data->subtitle2 }}" type="text" class="add_text" style="width:120px" />
                    </li>
                    <li class=" clearfix"><label class="label_name"><i>*</i>推荐小标题3:</label>
                        <input name="subtitle3" value="{{ $data->subtitle3 }}" type="text" class="add_text" style="width:120px" />
                    </li>
                    <li class=" clearfix"><label class="label_name"><i>*</i>推荐小标题4:</label>
                        <input name="subtitle4" value="{{ $data->subtitle4 }}" type="text" class="add_text" style="width:120px" />
                    </li>
                    <li class=" clearfix"><label class="label_name"><i>*</i>推荐小标题5:</label>
                        <input name="subtitle5" value="{{ $data->subtitle5 }}" type="text" class="add_text" style="width:120px" />
                    </li>
                    <li class=" clearfix"><label class="label_name"><i>*</i>推荐1商品ID列表：</label>
                        <input name="goods_id1" value="{{ $data->goods_id1 }}" type="text" class="add_text" style="width:120px" />
                    </li>
                    <li class=" clearfix"><label class="label_name"><i>*</i>推荐2商品ID列表：</label>
                        <input name="goods_id2" value="{{ $data->goods_id2 }}" type="text" class="add_text" style="width:120px" />
                    </li>
                    <li class=" clearfix"><label class="label_name"><i>*</i>推荐3商品ID列表：</label>
                        <input name="goods_id3" value="{{ $data->goods_id3 }}" type="text" class="add_text" style="width:120px" />
                    </li>
                    <li class=" clearfix"><label class="label_name"><i>*</i>推荐4商品ID列表：</label>
                        <input name="goods_id4" value="{{ $data->goods_id4 }}" type="text" class="add_text" style="width:120px" />
                    </li>
                    <li class=" clearfix"><label class="label_name"><i>*</i>推荐5商品ID列表：</label>
                        <input name="goods_id5" value="{{ $data->goods_id5 }}" type="text" class="add_text" style="width:120px" />
                    </li>
                    <li class=" clearfix"><label class="label_name">广告图片：</label>
                        <!-- 预览图片 -->
                        <div class="add-article-box-content">
                            <div class="img-preview" style="display: block; width: 150px; height: 121px;z-index:10"><img src="{{ $data->ad_img }}" width="100px" alt="" height="100px" /></div>
                        </div>
                        <div class="demo l_f">
                            <div class="add-article-box-content">
                                <!-- 保存裁切时的区域信息 -->
                                ...
                                <!-- 选择图片 -->
                                <input type="file" class="form-control" placeholder="点击按钮选择图片" id="logo" name="ad_img" autocomplete="off"
                                required>
                            </div>
                        </div>
                        <div class="prompt">
