...
<body>
    <div class=" clearfix">
    <form action="{{ route('brand_doedit',['id'=>$data->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="left_add">
                ...
                <ul class="add_conent">
                    ...
                    <li class=" clearfix"><label class="label_name">品牌图片：</label>
                        ...
                        <div class="add-article-box-content">
                            <div class="img-preview" style="display: block; width: 150px; height: 121px;z-index:10">
                                <img src="{{ $data->logo }}" width="100px" alt="" height="100px" />
                            </div>
                        </div>
                        <div class="demo l_f">
                            <div class="add-article-box-content">
                    ...
                    <li class=" clearfix"><label class="label_name"><i>*</i>产地：</label>
                        <input name="chandi" value="{{ $data->chandi }}" type="text" class="add_text" style="width:120px" /></li>
                    <li class=" clearfix"><label class="label_name">品牌描述：</label>
                        <textarea name="note" cols="" rows="" class="textarea" onkeyup="checkLength(this);">{{ $data->note }}</textarea>
