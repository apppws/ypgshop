...
<body>
    <div class=" clearfix" style="width:1200px">
        <form action="{{ route('blog_doadd') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="left_add">
                    ...
                    <ul class="add_conent">
                        ...
                        <li class=" clearfix"><label class="label_name"><i>*</i>日志名称：</label>
                            <input name="title" type="text" class="add_text"/>
                        </li>
                        <li class=" clearfix img"><label class="label_name">日志图片：</label>
                            ...
                            <div class="add-article-box-content">
                                <div class="img-preview" style="display: block; width: 150px; height: 121px;z-index:10"><img
                                        src="/images/image.png" width="100px" alt="" height="100px" /></div>
                            </div>
                            <div class="demo l_f">
                                <div class="add-article-box-content">
                                    <!-- 保存裁切时的区域信息 -->
                        ...
                        <li class=" clearfix"><label class="label_name">文章内容：</label>
                            <div class="formControls col-10">
                                <textarea id="editor" value="" name="content" autofocus style="width:100%;height:400px;"></textarea>
                            </div>
                        </li>
                        <li class=" clearfix"><label class="label_name"><i>*</i>是否显示：</label>
                            <input name="is_show" type="radio" class="add_text" style="width:10px" checked="checked"
                                value="y" /> 显示
                            <input name="is_show" type="radio" class="add_text" style="width:10px" value="n" /> 不显示
                        </li>
                    </ul>
                </div>
