...
<body>
    <div class=" clearfix">
    <form action="{{ route('spec_doadd') }}" method="POST" enctype="multipart/form-data">
            @csrf
        <div id="add_brand" class="clearfix">
            <div class="left_add">
                <div class="title_name">添加规格</div>
                <div class="clearfix cl">
                        <label class="form-label col-2">属性分类：</label>
                </div>
                <ul class="add_conent">
                    ...
                    <li class=" clearfix"><label class="label_name"><i>*</i>属性名称：</label>
                        <input name="spec_name" type="text" class="add_text" required / >
                    </li>
                </ul>
            </div>
        </div><br>
