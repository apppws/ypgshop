...
<body>
    <div class=" clearfix">
    <form action="{{ route('spec_doedit',['id'=>$data->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
        <div id="add_brand" class="clearfix">
            <div class="left_add">
                <div class="title_name">修改品牌</div>
                <ul class="add_conent">
                        <li class=" clearfix"><label class="label_name"><i>*</i>属性：</label>
                            <select name="attr_id">
                                    <option value="" selected="selected">==属性==</option>
                                    @foreach($attrCat as $v)
                                    <option @if($data->attr_id==$v->id) selected="selected" @endif value="{{$v->id}}">
                                        {{$v->attr_name}}
                                    </option>
                                    @endforeach
                                </select>
                    </li>
                    <li class=" clearfix"><label class="label_name"><i>*</i>规格名称：</label>
                        <input name="attr_name" value="{{ $data->spec_name }}" type="text" class="add_text" required / >
                    </li>
                </ul>
            </div>
