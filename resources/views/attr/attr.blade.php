        ...
        <div id="Member_Ratings">
            <div class="d_Confirm_Order_style">
                ...
                <div class="border clearfix">
                    <span class="l_f">
                        <a href="{{ route('attr_add') }}" id="member_add" class="btn btn-warning"><i class="icon-plus"></i>添加属性</a>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample-table">
                                ...
                                <tr>
                                  ...
                                  <td width="450px"  class="td-manage">
                                    ...
                                    <a title="编辑" href="/attr/edit/{{$v->id}}"  class="btn btn-xs btn-info" >
                                        <i class="icon-edit bigger-120"></i>
                                    </a>
                                    <a title="删除" onclick="confirm('你确定要删除吗？')" href="/attr/delete/{{ $v->id }}" onclick="member_del(this,'1')" class="btn btn-xs btn-warning" ><i class="icon-trash  bigger-120"></i></a>
                                  </td>
                                </tr>
                                @endforeach
                                </tbody>
